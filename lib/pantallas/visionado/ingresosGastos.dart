  ...
  Widget build(BuildContext context) {
     return PopScope(
        ...
        child:Obx(()=>Scaffold(
          ...
          appBar: appBar(datos: _datos.value, extras: _extras.value,ingreso: _ingreso.value, isIngreso: _isIngresos, onIngresoChange: _onIngresoChange,theme: Theme.of(context)),
                  ...
                  child:Column(
                    children: [
                      _datos.value.isNotEmpty
                        ? bodyHasDatos(gastos: _datos.value, onSaveValue: _onSaveValue, onDeleteValue: _onDeleteValue, theme: Theme.of(context),isIngresos: _isIngresos, extras: _extras,onSaveExtra: _onSaveExtra,onDeleteExtra: _onDeleteExtra)
                        : bodyHasNoDatos(),
